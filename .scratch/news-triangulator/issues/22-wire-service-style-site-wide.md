...
**Deferred, not in this ticket:** a dedicated navbar/masthead research and prototype round, informed by the same kind of primary-source investigation as `docs/research/2026-news-portal-visual-design.md` but focused specifically on masthead/navigation conventions. Do this before treating the navbar's current styling as final.
